...
class Length:
    ...
    def __init__(
        self, min: int = ..., max: int = ..., message: str | None = ...
    ) -> None: ...
...
class Regexp:
    ...
    message: str | None
    def __init__(
        self, regex: str | Pattern[str], flags: int = ..., message: str | None = ...
    ) -> None: ...
    def __call__(
        self, form: BaseForm, field: StringField, message: str | None = ...
    ) -> Match[str]: ...
...
class IPAddress:
    ...
    message: str | None
    def __init__(
        self, ipv4: bool = ..., ipv6: bool = ..., message: str | None = ...
    ) -> None: ...
    def __call__(self, form: BaseForm, field: StringField) -> None: ...
    @classmethod
...
class URL(Regexp):
    ...
    def __init__(
        self, require_tld: bool = ..., allow_ip: bool = ..., message: str | None = ...
    ) -> None: ...
    def __call__(self, form: BaseForm, field: StringField) -> None: ...
...
class AnyOf:
    ...
    def __init__(
        ...
        values: _ValuesT,
        message: str | None,
        values_formatter: Callable[[_ValuesT], str],
    ) -> None: ...
    @overload
    def __init__(
        self,
